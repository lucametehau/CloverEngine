...
TUNE_PARAM(NegativeImprovingMargin, -190, -300, -100);
TUNE_PARAM(RazoringDepth, 2, 1, 5);
TUNE_PARAM(RazoringMargin, 151, 100, 200);
...
TUNE_PARAM(ProbcutMargin, 181, 100, 300);
...
TUNE_PARAM(IIRCutNodeDepth, 5, 0, 5);
...
TUNE_PARAM(SEMargin, 54, 32, 96);
TUNE_PARAM(SEDoubleExtensionsMargin, 24, 15, 35);
TUNE_PARAM(MinLMRDepth, 2, 2, 4);
TUNE_PARAM(EvalDifferenceReductionMargin, 199, 100, 300);
TUNE_PARAM(HistReductionDiv, 8430, 7000, 10000);
...
TUNE_PARAM(AspirationWindowExpandMargin, 26, 10, 100);
TUNE_PARAM(AspirationWindowExpandBias, 0, 0, 10);
TUNE_PARAM(TimeManagerMinDepth, 9, 5, 11);
TUNE_PARAM(TimeManagerNodesSearchedMaxPercentage, 1547, 1200, 1800);
TUNE_PARAM(TimeManagerBestMoveMax, 1258, 1100, 1500);
TUNE_PARAM(TimeManagerBestMoveStep, 57, 10, 100);
TUNE_PARAM(TimeManagerScoreMin, 48, 40, 90);
TUNE_PARAM(TimeManagerScoreMax, 157, 110, 200);
TUNE_PARAM(TimeManagerScoreBias, 109, 10, 150);
TUNE_PARAM(TimeManagerScoreDiv, 107, 90, 150);
TUNE_PARAM(TimeManagerNodesSeachedMaxCoef, 112, 90, 200);
TUNE_PARAM(TimeManagerNodesSearchedCoef, 118, 50, 200);
TUNE_PARAM(LMRQuietBias, 123, 100, 200);
...
TUNE_PARAM(GoodNoisyPromotionBonus, 9765, 5000, 12000);
...
TUNE_PARAM(QuietPawnPushBonus, 9293, 8000, 12000);
...
// history constants
TUNE_PARAM(HistoryBonusMargin, 277, 250, 500);
TUNE_PARAM(HistoryBonusBias, 343, 200, 600);
TUNE_PARAM(HistoryBonusMax, 2446, 1800, 3000);
TUNE_PARAM(HistoryMalusMargin, 294, 200, 500);
TUNE_PARAM(HistoryMalusBias, 349, 200, 600);
TUNE_PARAM(HistoryMalusMax, 2464, 1800, 3000);
