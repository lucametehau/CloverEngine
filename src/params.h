...
TUNE_PARAM(LMRNoisyNotImproving, 1016, 412, 2048);
TUNE_PARAM(LMRBadNoisy, 1098, 512, 2048);
...
TUNE_PARAM(LMRFailLowPVHighDepth, 1173, 512, 2048);

TUNE_PARAM(EvalDifferenceReductionMargin, 202, 100, 300);
TUNE_PARAM(HistReductionDiv, 8499, 7000, 10000);
TUNE_PARAM(CapHistReductionDiv, 4164, 2048, 8192);
...
TUNE_PARAM_DOUBLE(LMRQuietBias, 1.1504805058591752, 1.00, 1.25);
TUNE_PARAM_DOUBLE(LMRQuietDiv, 2.550362273133956, 1.50, 2.70);
...
// LMR weights
TUNE_PARAM(lsw0, 90, -4096, 4096)
TUNE_PARAM(lsw1, 1068, -4096, 4096)
TUNE_PARAM(lsw2, -63, -4096, 4096)
TUNE_PARAM(lsw3, 36, -4096, 4096)
TUNE_PARAM(lsw4, 230, -4096, 4096)
TUNE_PARAM(lsw5, 2199, -4096, 4096)
TUNE_PARAM(lsw6, 1178, -4096, 4096)
TUNE_PARAM(lsw7, -19, -4096, 4096)
TUNE_PARAM(lsw8, -124, -4096, 4096)
TUNE_PARAM(lsw9, 238, -4096, 4096)
TUNE_PARAM(lsw10, 60, -4096, 4096)
TUNE_PARAM(lsw11, -52, -4096, 4096)
TUNE_PARAM(lsw12, -165, -4096, 4096)
TUNE_PARAM(lsw13, 77, -4096, 4096)
TUNE_PARAM(lsw14, 1230, -4096, 4096)
TUNE_PARAM(ldw0, -876, -4096, 4096)
TUNE_PARAM(ldw1, 97, -4096, 4096)
TUNE_PARAM(ldw2, -88, -4096, 4096)
TUNE_PARAM(ldw3, -82, -4096, 4096)
TUNE_PARAM(ldw4, -69, -4096, 4096)
TUNE_PARAM(ldw5, 368, -4096, 4096)
TUNE_PARAM(ldw6, -1032, -4096, 4096)
TUNE_PARAM(ldw7, 1038, -4096, 4096)
TUNE_PARAM(ldw8, 33, -4096, 4096)
TUNE_PARAM(ldw9, -157, -4096, 4096)
TUNE_PARAM(ldw10, 80, -4096, 4096)
TUNE_PARAM(ldw11, 176, -4096, 4096)
TUNE_PARAM(ldw12, 4, -4096, 4096)
TUNE_PARAM(ldw13, -135, -4096, 4096)
TUNE_PARAM(ldw14, 2067, -4096, 4096)
TUNE_PARAM(ldw15, 1331, -4096, 4096)
TUNE_PARAM(ldw16, -930, -4096, 4096)
TUNE_PARAM(ldw17, -3, -4096, 4096)
TUNE_PARAM(ldw18, -191, -4096, 4096)
TUNE_PARAM(ldw19, 375, -4096, 4096)
TUNE_PARAM(ldw20, 56, -4096, 4096)
TUNE_PARAM(ldw21, 1019, -4096, 4096)
TUNE_PARAM(ldw22, 1129, -4096, 4096)
TUNE_PARAM(ldw23, -1936, -4096, 4096)
TUNE_PARAM(ldw24, -935, -4096, 4096)
TUNE_PARAM(ldw25, 73, -4096, 4096)
TUNE_PARAM(ldw26, 192, -4096, 4096)
TUNE_PARAM(ldw27, 68, -4096, 4096)
TUNE_PARAM(ldw28, -119, -4096, 4096)
TUNE_PARAM(ldw29, -175, -4096, 4096)
TUNE_PARAM(ldw30, -7, -4096, 4096)
TUNE_PARAM(ldw31, -34, -4096, 4096)
TUNE_PARAM(ldw32, 130, -4096, 4096)
TUNE_PARAM(ldw33, 7, -4096, 4096)
TUNE_PARAM(ldw34, 123, -4096, 4096)
TUNE_PARAM(ldw35, -298, -4096, 4096)
TUNE_PARAM(ldw36, 22, -4096, 4096)
TUNE_PARAM(ldw37, 213, -4096, 4096)
TUNE_PARAM(ldw38, 14, -4096, 4096)
TUNE_PARAM(ldw39, 34, -4096, 4096)
TUNE_PARAM(ldw40, -102, -4096, 4096)
TUNE_PARAM(ldw41, -64, -4096, 4096)
TUNE_PARAM(ldw42, 50, -4096, 4096)
TUNE_PARAM(ldw43, 62, -4096, 4096)
TUNE_PARAM(ldw44, -111, -4096, 4096)
TUNE_PARAM(ldw45, -19, -4096, 4096)
TUNE_PARAM(ldw46, -118, -4096, 4096)
TUNE_PARAM(ldw47, -75, -4096, 4096)
TUNE_PARAM(ldw48, -91, -4096, 4096)
TUNE_PARAM(ldw49, 144, -4096, 4096)
TUNE_PARAM(ldw50, 107, -4096, 4096)
TUNE_PARAM(ldw51, 46, -4096, 4096)
TUNE_PARAM(ldw52, 163, -4096, 4096)
TUNE_PARAM(ldw53, 382, -4096, 4096)
TUNE_PARAM(ldw54, -32, -4096, 4096)
TUNE_PARAM(ldw55, -53, -4096, 4096)
TUNE_PARAM(ldw56, -18, -4096, 4096)
TUNE_PARAM(ldw57, 219, -4096, 4096)
TUNE_PARAM(ldw58, -55, -4096, 4096)
TUNE_PARAM(ldw59, 24, -4096, 4096)
TUNE_PARAM(ldw60, -32, -4096, 4096)
TUNE_PARAM(ldw61, -95, -4096, 4096)
TUNE_PARAM(ldw62, 23, -4096, 4096)
TUNE_PARAM(ldw63, 84, -4096, 4096)
TUNE_PARAM(ldw64, 32, -4096, 4096)
TUNE_PARAM(ldw65, 51, -4096, 4096)
TUNE_PARAM(ldw66, -78, -4096, 4096)
TUNE_PARAM(ldw67, 67, -4096, 4096)
TUNE_PARAM(ldw68, -163, -4096, 4096)
TUNE_PARAM(ldw69, -37, -4096, 4096)
TUNE_PARAM(ldw70, -192, -4096, 4096)
TUNE_PARAM(ldw71, 72, -4096, 4096)
TUNE_PARAM(ldw72, 59, -4096, 4096)
TUNE_PARAM(ldw73, 285, -4096, 4096)
TUNE_PARAM(ldw74, -62, -4096, 4096)
TUNE_PARAM(ldw75, -113, -4096, 4096)
TUNE_PARAM(ldw76, 29, -4096, 4096)
TUNE_PARAM(ldw77, 145, -4096, 4096)
TUNE_PARAM(ldw78, -20, -4096, 4096)
TUNE_PARAM(ldw79, -206, -4096, 4096)
TUNE_PARAM(ldw80, 120, -4096, 4096)
TUNE_PARAM(ldw81, -189, -4096, 4096)
TUNE_PARAM(ldw82, 25, -4096, 4096)
TUNE_PARAM(ldw83, -75, -4096, 4096)
TUNE_PARAM(ldw84, -71, -4096, 4096)
TUNE_PARAM(ldw85, 144, -4096, 4096)
TUNE_PARAM(ldw86, -60, -4096, 4096)
TUNE_PARAM(ldw87, -72, -4096, 4096)
TUNE_PARAM(ldw88, -16, -4096, 4096)
TUNE_PARAM(ldw89, 55, -4096, 4096)
TUNE_PARAM(ldw90, 34, -4096, 4096)
TUNE_PARAM(ldw91, 136, -4096, 4096)
TUNE_PARAM(ldw92, -36, -4096, 4096)
TUNE_PARAM(ldw93, 21, -4096, 4096)
TUNE_PARAM(ldw94, 126, -4096, 4096)
TUNE_PARAM(ldw95, -10, -4096, 4096)
TUNE_PARAM(ldw96, -172, -4096, 4096)
TUNE_PARAM(ldw97, 67, -4096, 4096)
TUNE_PARAM(ldw98, 1, -4096, 4096)
TUNE_PARAM(ldw99, 12, -4096, 4096)
TUNE_PARAM(ldw100, 69, -4096, 4096)
TUNE_PARAM(ldw101, -33, -4096, 4096)
TUNE_PARAM(ldw102, 8, -4096, 4096)
TUNE_PARAM(ldw103, 2, -4096, 4096)
TUNE_PARAM(ldw104, 10, -4096, 4096)
