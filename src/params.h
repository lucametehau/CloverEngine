...
TUNE_PARAM(LMRWasNotPV, 1024, 512, 2048);
TUNE_PARAM(LMRImprovingM1, 2048, 1024, 3072);
TUNE_PARAM(LMRImproving0, 1024, 512, 2048);

TUNE_PARAM(LMRPVNode, 1024, 512, 2048);
TUNE_PARAM(LMRGoodEval, 1024, 512, 2048);
TUNE_PARAM(LMREvalDifference, 1024, 512, 2048);
TUNE_PARAM(LMRRefutation, 2048, 1024, 3072);
TUNE_PARAM(LMRGivesCheck, 1024, 512, 2048);

TUNE_PARAM(LMRNoisyNotImproving, 1024, 412, 2048);
TUNE_PARAM(LMRBadNoisy, 1024, 512, 2048);

TUNE_PARAM(LMRCutNode, 2048, 1024, 3072);
TUNE_PARAM(LMRWasPVHighDepth, 1024, 512, 2048);
TUNE_PARAM(LMRTTMoveNoisy, 1024, 512, 2048);
TUNE_PARAM(LMRBadStaticEval, 1024, 512, 2048);
TUNE_PARAM(LMRFailLowPV, 1024, 512, 2048);
TUNE_PARAM(LMRFailLowPVHighDepth, 1024, 512, 2048);
