...
TUNE_PARAM(LMRBadNoisy, 1062, 512, 2048);
...
TUNE_PARAM(HistReductionDiv, 8540, 7000, 10000);
TUNE_PARAM(CapHistReductionDiv, 4037, 2048, 8192);
...
TUNE_PARAM_DOUBLE(LMRQuietBias, 1.148003982689628, 1.00, 1.25);
TUNE_PARAM_DOUBLE(LMRQuietDiv, 2.5923707330024692, 1.50, 2.70);
...
// LMR weights
TUNE_PARAM(lsw0, -185, -4096, 4096)
TUNE_PARAM(lsw1, 801, -4096, 4096)
TUNE_PARAM(lsw2, -144, -4096, 4096)
TUNE_PARAM(lsw3, -34, -4096, 4096)
TUNE_PARAM(lsw4, -188, -4096, 4096)
TUNE_PARAM(lsw5, 1971, -4096, 4096)
TUNE_PARAM(lsw6, 1463, -4096, 4096)
TUNE_PARAM(lsw7, -207, -4096, 4096)
TUNE_PARAM(lsw8, -420, -4096, 4096)
TUNE_PARAM(lsw9, 41, -4096, 4096)
TUNE_PARAM(lsw10, 273, -4096, 4096)
TUNE_PARAM(lsw11, -84, -4096, 4096)
TUNE_PARAM(lsw12, -201, -4096, 4096)
TUNE_PARAM(lsw13, 128, -4096, 4096)
TUNE_PARAM(lsw14, 1228, -4096, 4096)
TUNE_PARAM(ldw0, -615, -4096, 4096)
TUNE_PARAM(ldw1, 243, -4096, 4096)
TUNE_PARAM(ldw2, -309, -4096, 4096)
TUNE_PARAM(ldw3, -793, -4096, 4096)
TUNE_PARAM(ldw4, -113, -4096, 4096)
TUNE_PARAM(ldw5, 387, -4096, 4096)
TUNE_PARAM(ldw6, -724, -4096, 4096)
TUNE_PARAM(ldw7, 1316, -4096, 4096)
TUNE_PARAM(ldw8, -103, -4096, 4096)
TUNE_PARAM(ldw9, 179, -4096, 4096)
TUNE_PARAM(ldw10, 95, -4096, 4096)
TUNE_PARAM(ldw11, -425, -4096, 4096)
TUNE_PARAM(ldw12, 69, -4096, 4096)
TUNE_PARAM(ldw13, -270, -4096, 4096)
TUNE_PARAM(ldw14, 1699, -4096, 4096)
TUNE_PARAM(ldw15, 918, -4096, 4096)
TUNE_PARAM(ldw16, -510, -4096, 4096)
TUNE_PARAM(ldw17, -322, -4096, 4096)
TUNE_PARAM(ldw18, -271, -4096, 4096)
TUNE_PARAM(ldw19, 5, -4096, 4096)
TUNE_PARAM(ldw20, -200, -4096, 4096)
TUNE_PARAM(ldw21, 855, -4096, 4096)
TUNE_PARAM(ldw22, 1327, -4096, 4096)
TUNE_PARAM(ldw23, -1674, -4096, 4096)
TUNE_PARAM(ldw24, -1220, -4096, 4096)
TUNE_PARAM(ldw25, 254, -4096, 4096)
TUNE_PARAM(ldw26, 199, -4096, 4096)
TUNE_PARAM(ldw27, -102, -4096, 4096)
TUNE_PARAM(ldw28, 51, -4096, 4096)
TUNE_PARAM(ldw29, 3, -4096, 4096)
TUNE_PARAM(ldw30, 55, -4096, 4096)
TUNE_PARAM(ldw31, 187, -4096, 4096)
TUNE_PARAM(ldw32, -113, -4096, 4096)
TUNE_PARAM(ldw33, -202, -4096, 4096)
TUNE_PARAM(ldw34, 372, -4096, 4096)
TUNE_PARAM(ldw35, -8, -4096, 4096)
TUNE_PARAM(ldw36, -281, -4096, 4096)
TUNE_PARAM(ldw37, 416, -4096, 4096)
TUNE_PARAM(ldw38, -110, -4096, 4096)
TUNE_PARAM(ldw39, 199, -4096, 4096)
TUNE_PARAM(ldw40, 13, -4096, 4096)
TUNE_PARAM(ldw41, 231, -4096, 4096)
TUNE_PARAM(ldw42, -412, -4096, 4096)
TUNE_PARAM(ldw43, -97, -4096, 4096)
TUNE_PARAM(ldw44, -263, -4096, 4096)
TUNE_PARAM(ldw45, 225, -4096, 4096)
TUNE_PARAM(ldw46, -314, -4096, 4096)
TUNE_PARAM(ldw47, -151, -4096, 4096)
TUNE_PARAM(ldw48, -226, -4096, 4096)
TUNE_PARAM(ldw49, 127, -4096, 4096)
TUNE_PARAM(ldw50, -575, -4096, 4096)
TUNE_PARAM(ldw51, -299, -4096, 4096)
TUNE_PARAM(ldw52, -235, -4096, 4096)
TUNE_PARAM(ldw53, 85, -4096, 4096)
TUNE_PARAM(ldw54, 64, -4096, 4096)
TUNE_PARAM(ldw55, 30, -4096, 4096)
TUNE_PARAM(ldw56, 231, -4096, 4096)
TUNE_PARAM(ldw57, 347, -4096, 4096)
TUNE_PARAM(ldw58, -121, -4096, 4096)
TUNE_PARAM(ldw59, 188, -4096, 4096)
TUNE_PARAM(ldw60, -161, -4096, 4096)
TUNE_PARAM(ldw61, -160, -4096, 4096)
TUNE_PARAM(ldw62, -42, -4096, 4096)
TUNE_PARAM(ldw63, -170, -4096, 4096)
TUNE_PARAM(ldw64, -306, -4096, 4096)
TUNE_PARAM(ldw65, 297, -4096, 4096)
TUNE_PARAM(ldw66, 263, -4096, 4096)
TUNE_PARAM(ldw67, 64, -4096, 4096)
TUNE_PARAM(ldw68, -20, -4096, 4096)
TUNE_PARAM(ldw69, -22, -4096, 4096)
TUNE_PARAM(ldw70, -196, -4096, 4096)
TUNE_PARAM(ldw71, -217, -4096, 4096)
TUNE_PARAM(ldw72, 197, -4096, 4096)
TUNE_PARAM(ldw73, -224, -4096, 4096)
TUNE_PARAM(ldw74, 135, -4096, 4096)
TUNE_PARAM(ldw75, 315, -4096, 4096)
TUNE_PARAM(ldw76, 251, -4096, 4096)
TUNE_PARAM(ldw77, 150, -4096, 4096)
TUNE_PARAM(ldw78, 322, -4096, 4096)
TUNE_PARAM(ldw79, 55, -4096, 4096)
TUNE_PARAM(ldw80, -7, -4096, 4096)
TUNE_PARAM(ldw81, 61, -4096, 4096)
TUNE_PARAM(ldw82, -486, -4096, 4096)
TUNE_PARAM(ldw83, 144, -4096, 4096)
TUNE_PARAM(ldw84, -305, -4096, 4096)
TUNE_PARAM(ldw85, -81, -4096, 4096)
TUNE_PARAM(ldw86, -82, -4096, 4096)
TUNE_PARAM(ldw87, 99, -4096, 4096)
TUNE_PARAM(ldw88, 261, -4096, 4096)
TUNE_PARAM(ldw89, -78, -4096, 4096)
TUNE_PARAM(ldw90, 61, -4096, 4096)
TUNE_PARAM(ldw91, -210, -4096, 4096)
TUNE_PARAM(ldw92, 64, -4096, 4096)
TUNE_PARAM(ldw93, -293, -4096, 4096)
TUNE_PARAM(ldw94, 289, -4096, 4096)
TUNE_PARAM(ldw95, -204, -4096, 4096)
TUNE_PARAM(ldw96, 94, -4096, 4096)
TUNE_PARAM(ldw97, 44, -4096, 4096)
TUNE_PARAM(ldw98, -615, -4096, 4096)
TUNE_PARAM(ldw99, 106, -4096, 4096)
TUNE_PARAM(ldw100, 207, -4096, 4096)
TUNE_PARAM(ldw101, 356, -4096, 4096)
TUNE_PARAM(ldw102, -214, -4096, 4096)
TUNE_PARAM(ldw103, 319, -4096, 4096)
TUNE_PARAM(ldw104, -277, -4096, 4096)
