...
TUNE_PARAM(RazoringDepth, 3, 1, 5);
TUNE_PARAM(RazoringMargin, 149, 100, 200);
...
TUNE_PARAM(HistReductionDiv, 8240, 7000, 10000);
...
TUNE_PARAM(TimeManagerNodesSearchedMaxPercentage, 1567, 1200, 1800);
TUNE_PARAM(TimeManagerBestMoveMax, 1255, 1100, 1500);
TUNE_PARAM(TimeManagerBestMoveStep, 51, 10, 100);
TUNE_PARAM(TimeManagerScoreMin, 47, 40, 90);
TUNE_PARAM(TimeManagerScoreMax, 155, 110, 200);
TUNE_PARAM(TimeManagerScoreBias, 104, 10, 150);
TUNE_PARAM(TimeManagerScoreDiv, 114, 90, 150);
TUNE_PARAM(TimeManagerNodesSeachedMaxCoef, 107, 90, 200);
TUNE_PARAM(TimeManagerNodesSearchedCoef, 111, 50, 200);
TUNE_PARAM(LMRQuietBias, 116, 100, 200);
TUNE_PARAM(LMRQuietDiv, 260, 220, 300);
TUNE_PARAM(LMRNoisyBias, 64, 40, 100);
TUNE_PARAM(LMRNoisyDiv, 470, 300, 600);

// movepicker constants
TUNE_PARAM(GoodNoisyValueCoef, 9, 1, 20);
TUNE_PARAM(GoodNoisyPromotionBonus, 10151, 5000, 12000);
