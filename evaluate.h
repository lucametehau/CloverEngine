...
int weakKingSq[2] = {-21, 3, };

int knightBehindPawn[2] = {5, 8, };
...
int SafetyTable[2][100] = {
  {
    0, -1, 4, 1, 0, 6, 9, 5, 18, 16,
    38, 28, 13, 38, 29, 63, 51, 25, 58, 48,
    79, 69, 54, 81, 66, 112, 98, 86, 113, 109,
  ...
  {
    0, -4, -3, -4, 0, -3, 5, 13, 13, 17,
    25, 20, 27, 26, 35, 46, 34, 44, 48, 52,
...
int mobilityBonus[7][2][30] = {
    ...
    {},
    {
        ...
        {-30, -35, 6, 42, 52, 73, 74, 69, 46, },
    },
    {
        {-56, -10, 8, 13, 24, 30, 32, 33, 33, 39, 41, 57, 58, 63, },
        {-58, -65, -28, 5, 17, 38, 50, 55, 61, 62, 60, 46, 56, 33, },
    },
    {
        {-67, -29, -15, -8, -6, -5, -3, 1, 6, 11, 13, 18, 21, 32, 62, },
        {-92, -51, -18, 12, 31, 46, 58, 64, 71, 76, 82, 83, 84, 74, 50, },
    },
    {
        {-310, -148, -74, -8, 3, 15, 29, 31, 36, 38, 43, 45, 49, 52, 52, 51, 52, 47, 46, 41, 46, 52, 50, 56, 60, 123, 64, 124, },
        {-236, -90, -6, -85, -36, 5, -32, 9, 17, 43, 49, 72, 67, 80, 85, 93, 97, 101, 107, 110, 107, 103, 106, 106, 114, 69, 93, 132, },
    }
};
