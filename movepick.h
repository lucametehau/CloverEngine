        ...
        case STAGE_GEN_QUIETS:
        {
            if (!skip) {
                ...
                for (int i = 0; i < nrQuiets; i++) {
                    ...
                    score += searcher->nodesSearched[piece][from][to] / nodesSearchedDiv + 1000000; // the longer it takes a move to be refuted, the higher its chance to become the best move
                    scores[m++] = score;
                }
